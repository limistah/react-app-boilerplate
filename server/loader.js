...
function injectHTML(data, { html, title, meta, body, scripts, state }) {
  ...
  fs.readFile(
    ...
    (err, htmlData) => {
      ...
      */
      ...
      const context = {}; // Context for react router
      const modules = []; // Captured modules
      ...
      frontloadServerRender(() =>
        ...
        if (context.url) {
          ...
          const extraChunks = getBundles(stats, modules);
